...
public class ObjectFactory {
    ...
    private final static QName _Contract_QNAME = new QName("urn:kegoc.kz:SBRE:ZMM_0042_Contract", "Contract");
    private final static QName _ContractResp_QNAME = new QName("urn:kegoc.kz:SBRE:ZMM_0042_Contract", "Contract_Resp");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:kegoc.kz:SBRE:ZMM_0042_Contract", name = "Contract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:kegoc.kz:SBRE:ZMM_0042_Contract", name = "Contract_Resp")
