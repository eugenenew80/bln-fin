 ...
 * generated in the sap.erp.contract.sd package. 
...
public class ObjectFactory {
    ...
    private final static QName _Contract_QNAME = new QName("urn:kegoc.kz:BIS:LO_0001_Contract", "Contract");
    private final static QName _ContractResp_QNAME = new QName("urn:kegoc.kz:BIS:LO_0001_Contract", "Contract_Resp");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sap.erp.contract.sd
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:kegoc.kz:BIS:LO_0001_Contract", name = "Contract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:kegoc.kz:BIS:LO_0001_Contract", name = "Contract_Resp")
